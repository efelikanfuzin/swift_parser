...
class SwiftParserTest < Minitest::Test
  ...
  def test_fourth_block
    ...
    exp_ast = {
      ...
      '32A' => '180425CNY5355,',
      '33B' => 'CNY5355,',
      '50K' => '/305160034498SYM HOIST AND TOWER CRANE EQUIPMENTCO., LTD. ADD.ROOM 843,' \
               ' 81 PANGJIANG STREET DADONG DISTRICT, SHENYANG, CHINA, CHINA',
      '52A' => 'BKCHCNBJ82A',
      '53B' => '/C/30109156800000000174',
      '57A' => 'BELERUA1TCH',
      '59' => '/40702156710050000003OOO KRANTEHPRO 2801224221 ADD.UL B.HMELNICKOGO,DOM 42,' \
              'OF 404, G BLAGOVESHENSK, RUSSIA',
